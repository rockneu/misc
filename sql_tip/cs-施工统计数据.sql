...
select wpv.WorkType,    
            		   ...
            		   wpa.AllowWorkBeginTime,    
            		   wpa.WorkBeginTime, wpa.WorkFinishTime,WorkBeginApproveTime,WorkEndApproveTime,   
            	...
            	where wpv.Status in ('Approved','Ordered','Begin','Canceling','Canceled','Changing','Finish')     
            	   AND (PW.Category='OffForm' or PW.Category is null)  
	   AND  wpv.WorkPlanBeginDt >=  '2015-03-01'
	   AND wpv.WorkPlanBeginDt <=  '2015-04-01'
       --     	    {? AND wpv.WorkPlanBeginDt >= #WorkPlanBeginDtFrom# }   
       --     	    {? AND wpv.WorkPlanBeginDt <= #WorkPlanBeginDtTo# }     
		--CONVERT(varchar, '2011-7-19')as datetime)
