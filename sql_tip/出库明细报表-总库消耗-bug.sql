SELECT to_char(Mt.transaction_date,'yyyy-mm-dd') 出库日期，
 ...
 WHERE Mt.Inventory_Item_Id = m.Inventory_Item_Id 
   ...
   and substr(cis.Flex_Value,1,4)=substr(cic.flex_value,1,4)
   ...
   AND Ms.Attribute1 = '1'
   and Mt.Attribute1 in ('CK201310110010')
   --AND  m.Segment1='290020030004'
 ORDER BY Mt.Attribute1;
-- select m.attribute6, m.attribute12,m.* from Mtl_Material_Transactions m where Attribute1 in ('CK201310110010')